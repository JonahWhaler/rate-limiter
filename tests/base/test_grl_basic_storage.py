...
def test_grl_bs_check_limit_w_same_key(max_requests: int, time_window: int):
    # Parameter
    key = "key"
...
@pytest.mark.parametrize("max_requests,time_window", [(3, 3), (10, 5), (5, 4)])
def test_grl_bs__call__w_same_key(max_requests: int, time_window: int):
    # Parameter
    key = "key"
    rate_limiter = grl(STORAGE, max_requests=max_requests, time_window=time_window)
    t1 = time.time()
...
def test_grl_bs_check_limit_w_different_key(
...
def test_grl_bs__call__w_different_key(
    max_requests: int, time_window: int, number_of_key: int
):
    # Variable
    rate_limiter = grl(STORAGE, max_requests=max_requests, time_window=time_window)
...
def test_grl_bs_check_limit_w_different_key_sequence(
...
def test_grl_bs__call__w_different_key_sequence(
    max_requests: int, time_window: int, keys: list, key: Any, expected: bool
):
    # Variable
    rate_limiter = grl(STORAGE, max_requests=max_requests, time_window=time_window)
...
def test_grl_bs_check_limit_reset(max_requests: int, time_window: int):
    # Parameter
    key = "key"
    rate_limiter = grl(STORAGE, max_requests=max_requests, time_window=time_window)
    t1 = time.time()
...
@pytest.mark.parametrize("max_requests,time_window", [(3, 3), (4, 3), (10, 4)])
def test_grl_bs__call__reset(max_requests: int, time_window: int):
    # Parameter
    key = "key"
    rate_limiter = grl(STORAGE, max_requests=max_requests, time_window=time_window)
    t1 = time.time()
